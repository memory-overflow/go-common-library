...
// AddTask 添加任务
func (o *orderedMapContainer) AddTask(ctx context.Context, task framework.Task) (err error) {
	// TODO
	return nil
}

// GetRunningTask 获取运行中的任务
func (o *orderedMapContainer) GetRunningTask(ctx context.Context) (tasks []framework.Task, err error) {
	// TODO
	return tasks, err
}
...
func (o *orderedMapContainer) GetWaitingTask(ctx context.Context, limit int32) (tasks []framework.Task, err error) {
	// TODO
	return tasks, nil
}

// ToRunningStatus 转移到运行中的状态
func (o *orderedMapContainer) ToRunningStatus(ctx context.Context, task *framework.Task) (
...
func (o *orderedMapContainer) ToStopStatus(ctx context.Context, task *framework.Task) (
	newTask *framework.Task, err error) {
	// TODO
	return task, nil
}
...
func (o *orderedMapContainer) ToDeleteStatus(ctx context.Context, task *framework.Task) (
	newTask *framework.Task, err error) {
	// TODO
	return task, nil
}
...
func (o *orderedMapContainer) ToFailedStatus(ctx context.Context, task *framework.Task, reason error) (
	newTask *framework.Task, err error) {
	// TODO
	return
}
...
func (o *orderedMapContainer) ToExportStatus(ctx context.Context, task *framework.Task) (
	newTask *framework.Task, err error) {
	// TODO
	return task, nil
}
...
func (o *orderedMapContainer) ToSuccessStatus(ctx context.Context, task *framework.Task) (
	newTask *framework.Task, err error) {
	// TODO
	return task, nil
}
